    ...
    <div className={styles.messageBox}>
      ...
      <div className={styles.boxDescWrap}>
        ...
        <div className={styles.boxDesc}>
          ...
          <a href={props.Klaytnscope('tx', props.transactionHash)} target="result">{props.transactionHash}</a>
          <br />
          4) View your transaction & Contract Address:{' '}
          <a href={props.Klaytnscope( 'account', props.contractAddress )} target="result">{props.contractAddress}</a>
        </div>
